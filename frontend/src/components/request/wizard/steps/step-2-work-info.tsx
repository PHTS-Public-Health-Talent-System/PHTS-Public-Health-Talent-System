...
export function Step2WorkInfo({ data, updateData }: Step2Props) {
  ...
  useEffect(() => {
    if (!data.missionGroup && missionPrefill) {
      updateData("missionGroup", missionPrefill)
    }
  }, [data.missionGroup, missionPrefill, updateData])
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="mission" className="font-medium">หน้าที่ความรับผิดชอบหลัก</Label>
          <Input
            id="mission"
