...
import {
  buildAttachmentUrl,
  isPreviewableFile,
} from '../../../../(user)/user/request-detail-attachments';
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                {approvalActions
                  ...
                  .map((action) => (
                    <div key={`${action.action}-${action.step_no}-${action.action_date}`} className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {action.action_date ? new Date(action.action_date).toLocaleString('th-TH') : '-'}
                        </p>
                      </div>
                    </div>
                  ))}
