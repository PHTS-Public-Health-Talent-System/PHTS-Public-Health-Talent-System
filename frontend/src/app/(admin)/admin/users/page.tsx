...
import { TableRowMoreActionsTrigger } from '@/components/common';
                      ...
                      <TableCell className="text-right sticky right-0 bg-background group-hover:bg-muted/50 transition-colors">
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <TableRowMoreActionsTrigger className="md:opacity-0 md:group-hover:opacity-100 transition-opacity" />
                          </DropdownMenuTrigger>
